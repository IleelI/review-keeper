/*
  ...
  - Added the required column `userId` to the `ReviewReaction` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ReviewReaction" ("createdAt", "id", "reviewId", "typeId", "updatedAt") SELECT "createdAt", "id", "reviewId", "typeId", "updatedAt" FROM "ReviewReaction";
